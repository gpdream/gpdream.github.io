...
主要步骤:
        ...
        1.  客户端连接上node1,做了一次数据变更请求(index,create,delete)。
                ...
                1.  node1发现对应的请求数据(默认按id路由)在分片node3的p0上。将请求forwards到node3。
        2.  node3执行p0的数据操作，并在p0操作成功后，把请求发送给副本所在的node1的R0和node2的R0.所有副本分片都操作成功后，node3给node1报告操作成功。
...
<nav id="article-nav">
    ...
    ](/2018/05/04/es/lucene-2-core/)

    [
      **Older**
      <div class="article-nav-title">influxdb术语</div>
    ](/2017/07/03/influxdb/influxdb-term/)
...
*   [java](/tags/java/)
*   [machine-line](/tags/machine-line/)
*   [mycat](/tags/mycat/)
    </div>
  </div>
...
### 标签云
    ...
    <div class="widget tagcloud">
      [aliyun](/tags/aliyun/) [es](/tags/es/) [greenplum](/tags/greenplum/) [hadoop](/tags/hadoop/) [influxdb](/tags/influxdb/) [java](/tags/java/) [machine-line](/tags/machine-line/) [mycat](/tags/mycat/)
    </div>
  </div>
...
*   [四月 2019](/archives/2019/04/)
*   [二月 2019](/archives/2019/02/)
*   [八月 2018](/archives/2018/08/)
*   [七月 2018](/archives/2018/07/)
*   [六月 2018](/archives/2018/06/)
*   [五月 2018](/archives/2018/05/)
*   [二月 2018](/archives/2018/02/)
*   [七月 2017](/archives/2017/07/)
*   [六月 2017](/archives/2017/06/)
*   [五月 2017](/archives/2017/05/)
*   [三月 2017](/archives/2017/03/)
*   [二月 2017](/archives/2017/02/)
*   [一月 2017](/archives/2017/01/)
    </div>
  </div>
...
*   [elasticsearch 7重要更新内容](/2019/04/24/es/es7-changes/)
*   [人和wifi的亲密度,机器学习手把手教程](/2019/04/13/machine_learn/ml_lrcv/)
*   [java gc生产环境实践](/2019/02/01/java/gc-online/)
*   [es 6源码debug环境搭建](/2018/08/02/es/es-source-env/)
*   [x-pack sql做的sql优化](/2018/07/11/es/es-xpack-sql-optimizer/)
    </div>
  </div>
